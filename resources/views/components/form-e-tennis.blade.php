...
<div class="tab-pane fade" id="widget-tabbed-eTennis" role="tabpanel" aria-labelledby="eTennis-tab">

    <!-- eTennis Form Content -->
    <form method="POST" action="{{ route('profile.updateGame', ['game' => 'eTennis']) }}" class="rounded bg-white pb-5 form-signin w-auto text-uppercase">
        @csrf
        @method('PUT')
        <div class="row mb-3">
            <!-- eTennis Specific Fields -->
        ...
        <button type="submit" class="btn btn-primary w-100">Save eTennis</button>
    </form>
</div>
