...
<div class="tab-pane fade" id="widget-tabbed-eBasket" role="tabpanel" aria-labelledby="eBasket-tab">
    <!-- eBasket Form Content -->
    <form method="POST" action="{{ route('profile.updateGame', ['game' => 'eBasket']) }}" class="rounded bg-white pb-5 form-signin w-auto text-uppercase">
        @csrf
        @method('PUT')
        <div class="row mb-3">
            <!-- eBasket Specific Fields -->
        ...
        <button type="submit" class="btn btn-primary w-100">Save eBasket</button>
    </form>
</div>
